...
const TopActions: React.FC = () => {
  return (
    <div className="flex justify-between items-center bg-gradient-to-r from-green-500 to-red-500 px-3 py-2 ">
      <div className="flex gap-2 items-center">
        ...
        <button className="btn btn-xs">Go</button>
      </div>
      <div className="flex gap-2 items-center">
        <form>
        ...
        <button className="btn btn-xs">English</button>
      </div>
    </div>
  );
};
