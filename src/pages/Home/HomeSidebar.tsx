...
const HomeSidebar: React.FC = () => {
  return (
    <div>
      ...
      <div className="my-6">
        <h4 className="sidebarTitle">অফিস সংযুক্তির আবেদন ফরম</h4>
      </div>
      <div className="my-6">
        ...
        <img src={result} alt="ICT Division result" className="my-4" />
        <img src={internalService} alt="Internal Service" className="my-4" />
        <img src={myGOv} alt="My Gov" className="my-4" />
        <img src={eDirectory} alt="e-directory" className="my-4" />
      </div>
      ...
      <h5 className="sidebarTitle">কেন্দ্রীয় ই-সেবা</h5>
      <div className="my-6">
      ...
      <div className="my-6">
        ...
        <img src={discount} alt="ICT Division result" className="my-4" />
      </div>
      ...
      <div className="my-6">
        <h4 className="sidebarTitle">ডেঙ্গু প্রতিরোধে করণীয়</h4>
        <img src={dengue} alt="Dengue" className="w-full" />
      </div>
      <div className="my-6">
        <h4 className="sidebarTitle">জাতীয় সংগীত</h4>
        <audio controls>
